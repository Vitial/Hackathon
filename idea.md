...
Status: v2 core built and green — typecheck clean, **<!-- vital:testcount -->961/961 tests passing<!-- /vital:testcount -->**
...
**Typecheck: 0 errors. Tests: <!-- vital:testcount -->961/961 green<!-- /vital:testcount -->** (real sockets, real sqlite;
...
**The dogfood move.** Tag the deck's own claims — `FACT` <!-- vital:testcount -->961 tests green<!-- /vital:testcount -->
